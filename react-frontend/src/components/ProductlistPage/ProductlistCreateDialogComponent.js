    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="productlist-create-dialog-component">
                ...
                <div>
                    <p className="m-0" >exposure:</p>
                    <InputText className="w-full mb-3" value={_entity?.exposure} onChange={(e) => setValByKey("exposure", e.target.value)}  />
                </div>
                <div>
                    <p className="m-0" >iso:</p>
                    <InputText className="w-full mb-3" value={_entity?.iso} onChange={(e) => setValByKey("iso", e.target.value)}  />
                </div>
                <div>
